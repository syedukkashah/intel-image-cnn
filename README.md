...
9. Plotting training/validation metrics
...
This was done so that training data could be made more varied, while validation and test results stayed consistent and reliable.
